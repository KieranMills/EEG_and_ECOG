...
FUTURE_SAMPLE_PREDICT = 100 #five seconds multiplied by the sampling frequency

target_data = 'ECoG'
target_ECoG_Channels = [1]
...
df_targets = input_df[target_ECoG_Channels].shift(-FUTURE_SAMPLE_PREDICT)
#print(main_df)
...
#callback functions
path_checkpoint = 'ECoG_Checkpoint.keras'
...
try:
    ...
    print("Successfully loaded checkpoint   " + path_checkpoint)
